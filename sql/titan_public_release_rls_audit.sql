...
-- TITAN OS - Public release RLS/anon-key audit.
-- Run in Supabase SQL editor. It creates a read-only RPC that reports RLS,
-- policies and grants for the tables that matter before opening the app.
